...
from app.routers import assistant, auth, bookings, health, info, listings, notifications, posts, requests, search, societies
...
def create_app() -> FastAPI:
    ...
    application.include_router(societies.router)
