...
export const FIXTURE_POSTS: PostRead[] = [
  ...
  },
  {
    id: "fix-job-1",
    type: "JOB",
    title: "Junior software intern — campus tools",
    body: "Paid internship with the UCL digital team. Computing Year 2+. Applications close Friday.",
    status: "PUBLISHED",
    pinned: false,
    faculty: "COMPUTING",
    year: 2,
    ...
    event_at: null,
    deadline_at: "2026-09-26T10:30:00.000Z",
    apply_url: "https://example.invalid/ucl-intern",
    society_id: null,
  ...
  },
  {
    id: "fix-vol-1",
    type: "VOLUNTEERING",
    title: "Open day student ambassadors",
    body: "Show visitors around Block A and the library on Saturday. Lunch provided.",
    status: "PUBLISHED",
    pinned: false,
    faculty: null,
    year: null,
    ...
    expires_at: null,
    location: "Atrium",
    event_at: "2026-09-27T03:30:00.000Z",
    deadline_at: "2026-09-24T10:30:00.000Z",
    apply_url: null,
    society_id: null,
  ...
  },
  {
    id: "fix-alu-1",
    type: "ALUMNI",
    title: "Alumni coffee with the Business Society",
    body: "Recent graduates talk about first jobs in Colombo. Open to all years.",
    status: "PUBLISHED",
    pinned: false,
    faculty: "BUSINESS",
    year: null,
    ...
    event_at: "2026-09-25T10:00:00.000Z",
    deadline_at: null,
    apply_url: null,
    society_id: "soc-biz",
  ...
  },
  {
    id: "fix-hl-1",
    type: "HIGHLIGHT",
    title: "Axiom Computing Club wins the inter-faculty hack",
    body: "Congratulations to the Year 2 team that built a lost-and-found matcher in 24 hours.",
    status: "PUBLISHED",
    pinned: false,
    faculty: "COMPUTING",
    year: null,
