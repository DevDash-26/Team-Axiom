...
**Last updated:** 2026-09-19 (frontend-dev Phase 5 hardening + Wave 3 + FAQ intelligence on dev)
...
| Booking API, society/membership API, event interest API | Wave 2 leftovers after merge. |
...
2. Event interest + society membership APIs  
3. Wire staff lost-found UI to listings API  
